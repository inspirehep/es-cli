...
with open('_build/html/_static/CHANGELOG.txt', 'w') as changelog_fd:
    changelog_fd.write(get_changelog(
        project_dir='..',
        bugtracker_url='https://github.com/inspirehep/es-cli/issues/',
    ))
...
html_theme_options = {
    'description': 'ES-cli small cli tool to play with Elasticsearch indexes',
    ...
    'extra_nav_links': {
        'es-cli@GitHub': 'https://github.com/inspirehep/es-cli',
        'es-cli@PyPI': 'https://pypi.python.org/pypi/es-cli',
    }
}
...
htmlhelp_basename = 'es-cli_namedoc'
...
latex_documents = [
  (master_doc, 'es-cli.tex', u'es-cli Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'es-cli', u'es-cli Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'es-cli', u'es-cli Documentation',
   author, 'es-cli',
   'ES-cli small cli tool to play with Elasticsearch indexes',
   'Miscellaneous'),
]
